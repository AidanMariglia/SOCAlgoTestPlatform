...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{SRS/partner_applications.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{SRS/currentstate.png}
\end{figure}

\subsection{The Context of the Work}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{SRS/context.png}
\end{figure}
